...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.do2.setText(_translate("MainWindow", "dO2"))
        ...
        self.co2flow.setText(_translate("MainWindow", "CO2 Flow"))
        ...
        self.o2flow.setText(_translate("MainWindow", "O2 Flow"))
        self.group.setText(_translate("MainWindow", "Group"))
        self.datetime.setText(_translate("MainWindow", "Date/Time"))
        self.airflow.setText(_translate("MainWindow", "Air Flow"))
        self.operator_2.setText(_translate("MainWindow", "Operator"))
        self.filename.setText(_translate("MainWindow", "Manual Log"))
        self.log.setText(_translate("MainWindow", "Log"))
        self.file_name.setText(_translate("MainWindow", "Manual Log File Name "))
        self.interval.setText(_translate("MainWindow", "Interval (s)"))
        self.O2_flow.setText(_translate("MainWindow", "O2 Flow (lpm) SP"))
        self.feed_pump.setText(_translate("MainWindow", "Feed Pump ON"))
        self.Mode.setText(_translate("MainWindow", "Mode"))
        self.Temperature.setText(_translate("MainWindow", "Temperature (ºC) SP"))
        self.Airflow.setText(_translate("MainWindow", "Air Flow (lpm) SP"))
        self.mode.setItemText(0, _translate("MainWindow", "Setpoint"))
